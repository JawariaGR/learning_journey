...
function addNumberString(type1: number, type2: string): number {
...
function roundOff(value1: number, value2: number): number {
...
function divedAndRemainder(number1:number,number2:number){
