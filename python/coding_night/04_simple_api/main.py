...
side_hustles = [
    ...
    "App Development - Create moblie or web application for businesses"
]
...
money_quotes = [
    ...
    "Money often costs too mush. - Ralph Waldo Emerson","Never depend on a single income. Make an investment to create a second source. – Warren Buffett",
